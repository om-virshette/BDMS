                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="useraddedblood.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="om virshette" type="text" name="name" required>
                                        </div>
                                        ...
                                        <div class="form-group gender1">
                                            ...
                                            <input class=""  type="radio" name="gender" value = "Female" required>Female
                                        </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" name="collection" placeholder= "ML"required>
                                            </div>
